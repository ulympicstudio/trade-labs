...
export TL_SIG_MIN_EVENT_SCORE_CONSENSUS=38
export TL_SIG_MIN_EVENT_SCORE_DEV=20
export TL_SIG_SPREAD_MAX_PCT=0.005    # relax spread gate for SIM quotes
export TL_RSI_WARMUP_BARS=5             # allow RSI with fewer bars (paper mode)
export TL_HEARTBEAT_TIMEOUT_S=180       # watchdog relaxed for after-hours
